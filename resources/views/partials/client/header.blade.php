<header class="m-hd">
    <section data-am-sticky class="am-show-md-up">
        <div class="am-container">
            <a href="/" rel="nofollow" class="m-logo" style="background: url({{asset($my_config->website_logo)}}) no-repeat left center;"><i class="am-icon-spinner"></i> J2 Network</a>
            ...
            <nav>
                <ul class="m-nav am-nav am-nav-pills am-fr">
                    ...
                    {{--<li class="am-dropdown" data-am-dropdown><a href="/case" rel="nofollow" class="am-dropdown-toggle" data-am-dropdown-toggle>案例展示 <span class="am-icon-caret-down"></span></a>
                    ...
                    <li><a href="/case" rel="nofollow">模板案例</a></li>
                    {{--<li><a href="/case" rel="nofollow">协助伙伴</a></li>--}}
                    <li><a href="/fuwu" rel="nofollow">服务内容</a></li>
